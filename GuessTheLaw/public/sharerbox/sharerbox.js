...
export function sharerbox(options) {
	...
	<div class="sharerbox-icon-fig" id="fb-fig">
		<a class="sharerbox-socialmedia-link" id="fb-link" target="_blank" aria-label="Open Facebook">
	...
	<div class="sharerbox-icon-fig" id="tw-fig">
		<a class="sharerbox-socialmedia-link" id="tweet-link" target="_blank" aria-label="Open Twitter">
	...
	<div class="sharerbox-icon-fig" id="ws-fig">
		<a class="sharerbox-socialmedia-link" id="ws-link" target="_blank" aria-label="Open Whatsapp">
	...
	<div class="sharerbox-icon-fig" id="reddit-fig">
		<a class="sharerbox-socialmedia-link" id="reddit-link" target="_blank" aria-label="Open Reddit">
	...
	<div class="sharerbox-icon-fig" id="linkedin-fig">
		<a class="sharerbox-socialmedia-link" id="linkedin-link" target="_blank" aria-label="Open Linkedin">
	...
	<div class="sharerbox-icon-fig" id="pinterest-fig">
		<a class="sharerbox-socialmedia-link" id="pinterest-link" target="_blank" aria-label="Open Pinterest">
	...
	<div class="sharerbox-icon-fig" id="tumblr-fig">
		<a class="sharerbox-socialmedia-link" id="tumblr-link" target="_blank" aria-label="Open Tumblr">
	...
	<div class="sharerbox-icon-fig" id="telegram-fig">
		<a class="sharerbox-socialmedia-link" id="telegram-link" target="_blank" aria-label="Open Telegram">
	...
	<div class="sharerbox-icon-fig" id="trello-fig">
		<a class="sharerbox-socialmedia-link" id="trello-link" target="_blank" aria-label="Open Trello">
	...
	<div id="sharerbox-hidden-icons-wrap">
		...
		<div class="extra-buttons-fig" id="other-social-media-fig">
		...
		<!--Send Email Button-->
		<div class="extra-buttons-fig" id="send-email-button-fig">
			<a class="sharerbox-socialmedia-link" id="send-email-link" title="Email" aria-label="Open Email">
		...
		<!--Copy URL Button-->
		<div class="extra-buttons-fig" id="copy-link-fig" title="Copy Link">
	...
	<div id="sharerbox-share-icon-wrap">
		<!--Share Icon-->
		<div id="sharerbox-share-icon-fig" title="Share!">
